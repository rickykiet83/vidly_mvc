...
namespace Vidly_MVC.Migrations
{
    ...
    [Migration("20240423070402_Create_Rental")]
    partial class Create_Rental
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vidly_MVC.Models.Rental", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Vidly_MVC.Models.Rental", b =>
                {
                    b.HasOne("Vidly_MVC.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vidly_MVC.Models.Movie", "Movie")
                        .WithMany()
